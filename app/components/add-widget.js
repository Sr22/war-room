    ...
    .factory('addWidget', ['$compile', function($compile) {
      ...
      service.addWidget = function(widget, scope, callback) {
        if (widget instanceof Array) {
          body = '<ww-widget data-row=1 data-col=1 data-sizex=1 data-sizey=2><include-executable-file src="' + widget[0] + '"></include-executable-file></ww-widget><span class="gs-remove-handle gs-remove-handle-all"></span>';
          ...
          body = '<ww-widget data-row=1 data-col=1 data-sizex=1 data-sizey=2><include-executable-file src="' + widget + '"></include-executable-file></ww-widget><span class="gs-remove-handle gs-remove-handle-all"></span>';
          var el = angular.element(body);
          var compiled = $compile(el);
          $('.ww-widgets-ul').append(el);
          compiled(scope);
